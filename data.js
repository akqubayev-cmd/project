...
image_question=[[' Каковы основные причины необходимости параллельных и распределённых вычислений?', ' Сокращение времени, требуемого для решения задач с большим объёмом вычислений.', ' Увеличение скорости работы только однопроцессорных систем.', ' Решение задач, связанных только с обработкой изображений.', ' Повторение одних и тех же операций.', ' Ускорение разработки программного обеспечения.'],
...
console.log(image_question.length)
